...
class IrcPlugin(BasePlugin):
    ...
    def on_chat_sent(self, data):
        ...
        if parsed.message.startswith(self.prefix * 2) and not parsed.message.startswith(self.prefix * 3):
            return True
            ## quick dirty removal of admin messages to administrators from briding over to irc.
